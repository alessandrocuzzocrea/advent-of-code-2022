...
Console.WriteLine($"Part 1: {Day1.Part1("./inputs/day1")}");
...
Console.WriteLine($"Part 1: {Day3.Part1("./inputs/day3")}");
...
Console.WriteLine($"Part 1: {Day9.Part1("./inputs/day9")}");
Console.WriteLine($"Part 2: {Day9.Part2("./inputs/day9")}");
...
// Console.WriteLine($"Part 2: {Day14.Part2("./inputs/day14-example")}");
